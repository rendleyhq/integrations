...
| --- | --- | --- | --- |
| [`n8n-prompt-to-video-node.json`](n8n-prompt-to-video-node.json) | Manual | Prompt to Video with **Render MP4 After Edit**; the hero flow in one node | Agent |
...
- **Wait inline.** Most templates leave **Wait for Completion** on: the node polls
...
- **Paid plan and credits.** The agent and exports need a paid Rendley plan (HTTP 402
