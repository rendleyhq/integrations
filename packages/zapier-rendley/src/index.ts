...
import { startExport, startPromptToVideo } from "./creates/agentAndExport";
...
const App = {
  ...
  platformVersion,
  // Keep list inputs (Media URLs, Reference Images) exactly as entered.
  ...
  creates: {
    [startPromptToVideo.key]: startPromptToVideo,
